...
void Demande_Prenom()
{
    ...
    cin >> prenom;
    cout <<"Bonjour ! votre prenom est " << prenom << endl;
    cin.ignore();
}
...
void Demande_Nom_Prenom()
{
    ...
    cout <<"Bonjour ! votre nom et prenom est " << nom_prenom << endl;
}
...
void Devinette_Evolution()
{
    ...
    cout <<"Felicitation ! Vous avez réussis au bout de " << compteur << " fois."<< endl;
}
